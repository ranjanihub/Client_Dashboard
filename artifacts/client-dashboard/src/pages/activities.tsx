                ...
                <div className="relative h-52 w-full overflow-hidden bg-slate-100">
                  ...
                  <div className="absolute top-4 right-4 flex items-center gap-2">
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end" className="w-52 rounded-2xl p-2 shadow-xl border-slate-200">
                        <DropdownMenuItem
                          onClick={() => handlePreviewActivity(act)}
                          className="flex items-center gap-2.5 px-3 py-2 text-sm font-bold rounded-xl cursor-pointer text-[#5e2be2] bg-purple-50/50 hover:bg-purple-100/70"
                        >
                          <Play className="w-4 h-4 text-[#5e2be2] fill-[#5e2be2]" />
